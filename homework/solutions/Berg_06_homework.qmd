...
my_priors <- c(prior(normal(77.6, 40.1), class = 'Intercept'),
                  prior(normal(77.6, 40.1), class = 'b', coef = 'SemSimilar')
               # Timo lazy   , prior(normal(0, 10), class = 'sigma'))
              )
#Timos priors
...
# In class
# Comparing light blue to dark blue
# We assume a normal distribution, which the data does not show exactly, optionally, can we fix it
