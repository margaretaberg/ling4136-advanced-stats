...
pacman::p_load(rstudioapi, tidyverse, lme4, brms, bayestestR, tidybayes)
...
my_priors <- c(prior(normal(6.5, 2.5), class = 'Intercept'),
               prior(normal(0, 3), class = 'b', coef = 'log_frequency'))
...
# check convergence
mcmc_plot(model_quant, type = "trace")
#mostly looks caterpillary, but different kinds
