...
Run an appropriate linear mixed effects model to test this hypothesis. 
If you run into convergence issues, deal with them as you see fit.
...
Tip: You have to set `re.form = NA` if you use the `predict()` function:
