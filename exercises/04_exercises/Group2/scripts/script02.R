...
# load in data
raw_data <- read_bulk("/Users/timoroettger/Research/Reproducibility workshop/Exercises/ReproduceThat/Group2/raw", extension = ".csv") 
subject_info <- read_csv("/Users/timoroettger/Research/Reproducibility workshop/Exercises/ReproduceThat/Group2/data/vp_info.csv")                     
...
## trim data: 
### for each subject and each mood condition, exclude data points that are smaller/greater than 2 SDs from the mean 
data_trimmed <- data %>% group_by(vp_id, var_001) %>% 
...
setwd("/Users/timoroettger/Research/Reproducibility workshop/Exercises/ReproduceThat/Group2/data/")      

save(xmdl, xmdl_red, model_comp,
     file = "model_output.RData")
...
setwd("/Users/timoroettger/Research/Reproducibility workshop/Exercises/ReproduceThat/Group2/plots/")        
